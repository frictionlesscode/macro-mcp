...
Copied verbatim from garmin-mcp's auth.py (SPEC.md M5, "OAuth provider copied from
garmin-mcp") -- this module has no garmin-specific logic in it.
"""
...
def client_key(request: Request) -> str:
    ...
    publish (127.0.0.1:18081) -- nothing on the public internet can connect
